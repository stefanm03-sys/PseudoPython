...
ERROR_TEMPLATES = {
    ...
    "PPY-IO-404": "[PPY-IO-404] File not found! May be invalid: {path}",
    ...
    "PPY-TYPE-001": "[PPY-TYPE-001] Operator '{op}' requires numbers, I got {actual_type}. Maybe check: {detail}",
    ...
    "PPY-EXEC-001": "[PPY-EXEC-001] execute(...) command failed (exit {return_code}): {command}",
